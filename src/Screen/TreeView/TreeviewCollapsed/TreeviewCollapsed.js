...
class TreeviewCollapsed extends Component {
    constructor(props){
        super(props);
        this.state = {
            treeviewDefaultList,
        ...
        <div className="treeviewdefault-col-lg-6">
            <div className="treeviewdefault-card">
                <div className="treeviewdefault-card-body">
                    <h5 className="treeviewdefault-card-title">Collapsed</h5>
                </div>
...
export default TreeviewCollapsed;